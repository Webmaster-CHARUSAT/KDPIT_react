          ...
          <Row className="justify-content-between">
            ...
            <Col lg={4} md={6} className="mb-8 mb-lg-0">
              ...
              <ul className="space-y-3 pl-0">
                ...
                <li className="flex items-center">
                  ...
                  />
                  <a
                    href="mailto:hod.it@charusat.ac.in"
                    className="hover:text-green-400 transition-colors duration-300"
                  >
              ...
              <div className="mt-6">
                <h4 className="text-sm uppercase tracking-wider mb-3 text-gray-400">
                  Connect With Us
                </h4>
              ...
              <ul className="mt-5 grid grid-cols-1 gap-2">
                <li>
                  <a
                    ...
                    className="text-gray-300 hover:text-green-400 flex items-center transition-all duration-300 hover:translate-x-1 py-1"
                  >
                    <FontAwesomeIcon
                      icon={faChevronRight}
                      className="mr-2 text-green-400 text-xs"
                    />
                    Exam Results
                  </a>
                </li>
                ...
                <li>
                  <a
                    href="https://charusat.edu.in:912/OthPaymentApp/frmFeesPayment.aspx"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-300 hover:text-green-400 flex items-center transition-all duration-300 hover:translate-x-1 py-1"
                  >
                ...
                <li>
                  <a
                    href="https://www.charusat.ac.in/files/CHARUSAT-STATUTES%20HANDBOOK.pdf"
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="text-gray-300 hover:text-green-400 flex items-center transition-all duration-300 hover:translate-x-1 py-1"
                  >
            ...
            <Col lg={4} md={12}>
              ...
              <div className="mt-5 flex flex-col items-center">
                ...
                {/* LinkedIn Link */}
                <a
                  href="https://www.linkedin.com/in/kabir-mota"
                  target="_blank"
                  rel="noopener noreferrer"
                  className=" w-9 h-9 bg-gray-800 hover:bg-green-500 text-white rounded-full flex items-center justify-center transition-all duration-300 hover:-translate-y-1"
