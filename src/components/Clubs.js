  ...
  return (
    <section
      ...
      style={{
        ...
        backgroundImage:
          "linear-gradient(rgba(0,0,0,0.9), rgba(0,0,0,0.7)), url('/images/extra/6.jpg')",
      }}
    >
            ...
            return (
              <div
                ...
                onClick={
                  clickable
                    ? () =>
                        window.open(club.link, "_blank", "noopener,noreferrer")
                    : undefined
                }
                tabIndex={clickable ? 0 : -1}
                role={clickable ? "button" : undefined}
                aria-label={
                  clickable ? `Visit ${club.name} website` : undefined
                }
              >
                {/* Logo Container */}
                <div className="relative z-10 flex justify-center mb-8">
                  <div className="w-36 h-36 bg-white rounded-3xl p-2 shadow-2xl group-hover:shadow-3xl transition-all duration-300 group-hover:scale-105 flex items-center justify-center">
                    ...
                    />
                    <div className="w-full h-full bg-gray-200 rounded-lg items-center justify-center text-gray-500 text-sm hidden font-bold">
                      {club.id}
                    </div>
                  </div>
                </div>
